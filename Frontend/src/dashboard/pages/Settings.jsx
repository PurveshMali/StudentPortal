            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 border border-purple-300 dark:border-purple-600 rounded-md">
                ...
                <input
                  ...
                  className="w-4 h-4 text-primary bg-purple-100 border-purple-300 focus:ring-primary dark:focus:ring-primary dark:ring-offset-purple-800 focus:ring-2 dark:bg-purple-700 dark:border-purple-600"
                />
              </div>
